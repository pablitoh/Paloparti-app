...
const TeamsList = React.memo(function TeamsList({
  playersA,
  playersB,
  tbdPlayersTeamA = [],
  tbdPlayersTeamB = [],
  ...
  const teamAAvgRating = useMemo(() => calculateLocalAvgRating(teamA), [teamA]);
  const teamBAvgRating = useMemo(() => calculateLocalAvgRating(teamB), [teamB]);
