...
export enum LogAction {
  ...
  ADMIN_CONFIRMED_ATTENDANCE = 'ADMIN_CONFIRMED_ATTENDANCE',
  MATCH_COMPLETED = 'MATCH_COMPLETED',
  MEMBER_RATING_UPDATED = 'MEMBER_RATING_UPDATED',
  STAR_RATING_UPDATED = 'STAR_RATING_UPDATED',

  // Acciones de jugadores fantasma
  GHOST_PLAYER_CREATED = 'GHOST_PLAYER_CREATED',
  GHOST_PLAYER_DELETED = 'GHOST_PLAYER_DELETED',
