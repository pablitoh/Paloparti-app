...
export default function Register({ callbackUrl }: RegisterProps) {
  ...
  return (
    <>
      {/* CSS específico para campo de fecha en móvil */}
      <style jsx>{`
        input[type='date'] {
      ...
      <div className='min-h-screen bg-gradient-green flex items-center justify-center px-4 py-6'>
        <div className='w-full max-w-sm'>
          ...
          <form onSubmit={handleSubmit} className='space-y-3 mb-4'>
            ...
            {/* Campo de fecha con estilos específicos para móvil */}
            <input
              type='date'
              name='birthdate'
              className='w-full px-4 py-3 bg-white/90 backdrop-blur-sm rounded-xl border-0 focus:outline-none focus:ring-4 focus:ring-white/50 focus:bg-white transition-all duration-200 min-h-[48px] box-border'
              ...
              style={
                {
                  ...
                  colorScheme: 'light',
                  color: '#1f2937', // gray-800 en hex
                  '--webkit-datetime-edit-text-color': '#1f2937',
                  '--webkit-datetime-edit-month-field-color': '#1f2937',
                  '--webkit-datetime-edit-day-field-color': '#1f2937',
                  '--webkit-datetime-edit-year-field-color': '#1f2937',
