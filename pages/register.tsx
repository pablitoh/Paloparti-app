      ...
      <div className='w-full max-w-sm'>
        ...
        <div className='space-y-2'>
          ...
          <button
            ...
            className='w-full bg-black/20 backdrop-blur-sm text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 hover:bg-black/30 flex items-center justify-center space-x-3'
          >
