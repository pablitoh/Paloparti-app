  ...
  try {
    ...
    if (!supabaseAdmin) {
      return res.status(500).json({
        message:
          'Error de configuración: Supabase no está configurado correctamente. Verifica las variables de entorno NEXT_PUBLIC_SUPABASE_URL y SUPABASE_SERVICE_ROLE_KEY',
      });
    }
