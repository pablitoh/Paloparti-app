 ...
 * Este endpoint está diseñado específicamente para funcionar en ambientes desplegados como Vercel
 */
export default async function handler(
  ...
  try {
    ...
    console.error('Error in /api/auth/register/index.ts:', error);
